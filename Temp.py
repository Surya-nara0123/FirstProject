...
bc_image = pygame.image.load("HariniAssets/im2.jpeg").convert_alpha()
...
ec_image = pygame.image.load("HariniAssets/im 5.jpeg").convert_alpha()
...
def base():
    ...
    while run:
        ...
        aa_image = pygame.image.load("HariniAssets/11.png").convert_alpha()
